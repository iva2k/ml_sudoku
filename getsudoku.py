...
from sudoku import Sudoku, solve_eliminator, count_solutions


def load_websudoku(url):
    """Load a sudoku puzzle from the given URL."""
...
def main():
    ...
    s.solver(s.quiz, None, 1)
    s.solver(s.quiz, solve_eliminator, 1)
